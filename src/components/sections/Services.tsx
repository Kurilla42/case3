        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {services.map((s) => (
            <motion.div 
              ...
              viewport={{ once: true }}
              className="bg-white border border-black p-8 group relative flex flex-col justify-between"
            >
              <div className="space-y-6">
                ...
                <div className="space-y-3">
                  <h3 className="text-2xl font-headline m-0">{s.title}</h3>
              ...
              <div className="mt-12 pt-6 border-t border-black border-dashed flex justify-between items-center">
                ...
                <div className="w-8 h-8 border border-black flex items-center justify-center group-hover:bg-black group-hover:text-white transition-colors cursor-pointer">
